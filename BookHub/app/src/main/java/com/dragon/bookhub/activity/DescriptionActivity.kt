    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(ConnectionManager().checkConnectivity(this@DescriptionActivity)){
            ...
            val jsonRequest = object:JsonObjectRequest(Request.Method.POST,url,jsonParams,Response.Listener {
                //            val errorData = it.getJSONObject("data")
//            println("Error is ${errorData.getString("errorMessage")}")
                ...
                try{
                    ...
                    if(success) {
                        ...
                        Toast.makeText(this@DescriptionActivity,"Success False",Toast.LENGTH_SHORT).show()
                    }
                }catch (e:Exception){
                    Toast.makeText(this@DescriptionActivity,"Some Error Has Occurred!! $e",Toast.LENGTH_SHORT).show()
                }
