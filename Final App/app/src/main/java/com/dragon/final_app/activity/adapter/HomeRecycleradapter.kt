...
class HomeRecyclerAdapter(val context: Context, val itemList: ArrayList<Rest>) :
    ...
    override fun onBindViewHolder(holder: HomeViewHolder, position: Int) {
        try {
            ...
            holder.llContent.setOnClickListener {
                ...
                intent.putExtra("restId", rest.restId)
                intent.putExtra("restName", rest.restName)
                intent.putExtra("restRating", rest.restRating)
                intent.putExtra("restPrice", rest.Price)
                intent.putExtra("restImage", rest.restImage)
